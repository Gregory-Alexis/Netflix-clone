...
import SubNavBar from "./SubNavBarTvShowsSuggestion";

const NavBarTvShowsSuggestion = () => {
  const search = useSelector((state) => state.suggestionTvShowsData.search);
  const isActive = useSelector((state) => state.suggestionTvShowsData.isActive);
...
export default NavBarTvShowsSuggestion;
